...
public abstract class Intersection implements Drawable {
     ...
     * @author jvacek
     * @return ArrayList&#60;Intersection&#62; with all the neighbouring intersections
     */
    //TODO please verify this works
    public ArrayList<Intersection> getNeighbours() {
	ArrayList<Intersection> ret = new ArrayList<Intersection>();	
	for (Road r : getRoads()) {
